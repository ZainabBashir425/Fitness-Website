    ...
    <>
      <div className="blog-hero">
        ...
        <p className="blog-hero-text">
          Explore expert articles and guides on fitness and nutrition to help
      ...
      <div className="blog-cards">
        <div className="blog-card">
          <div className="blog-card-content">
            ...
            <p className="blog-card-text">
              An introductory guide to understanding macronutrients and meal
              planning, perfect for users just starting their fitness journey.
            </p>
          </div>
        ...
        <div className="blog-card">
          <div className="blog-card-content">
            ...
            <p className="blog-card-text">
              Strategies for meal planning and nutrition tracking without
              breaking the bank, appealing to cost-conscious users.
            </p>
          </div>
          <div className="blog-card-author">
            <img src={blogA2} alt="" />
        ...
        <div className="blog-card">
          <div className="blog-card-content">
            ...
            <p className="blog-card-text">
              An exploration of why logging workouts and nutrition can lead to
              better results and how to interpret progress graphs and
              statistics.
            </p>
          </div>
          <div className="blog-card-author">
        ...
        <div className="blog-card">
          <div className="blog-card-content">
            ...
            <div className="blog-card-title">
              <h5 className="blog-card-heading">
                Navigating Fitness Myths: What You Need to Know
              </h5>
              <img src={arrowUpRightIcon} alt="" />
            </div>
            <p className="blog-card-text">
              Debunking common fitness myths and misconceptions, providing users
              with reliable information to support their journey.
            </p>
          </div>
          <div className="blog-card-author">
            <img src={blogA5} alt="" />
        ...
        <div className="blog-card">
          <div className="blog-card-content">
            ...
            <div className="blog-card-title">
              <h5 className="blog-card-heading">
                Top 10 Home Workouts You Can Do Anywhere
              </h5>
              <img src={arrowUpRightIcon} alt="" />
            </div>
            <p className="blog-card-text">
              A curated list of effective workouts that require minimal
              equipment, catering to users looking for flexibility in their
              fitness routines.
            </p>
          </div>
          <div className="blog-card-author">
      ...
      <div className="blogs-trending">
        ...
        <p className="trending-content">
          Stay updated with the latest fitness trends, tips, and insights to
        ...
        <div className="blog-cards">
          <div className="blog-card">
            <div className="blog-card-content">
              ...
              <p className="blog-card-text">
                Explore how hybrid workouts are gaining popularity and how to
                incorporate them into your routine for maximum benefits.
              </p>
            </div>
            <div className="blog-card-author">
              <img src={blogA1} alt="" />
          ...
          <div className="blog-card">
            <div className="blog-card-content">
              ...
              <p className="blog-card-text">
                Learn about the growing trend of integrating mindfulness
                practices into fitness routines to enhance both mental and
                physical health.
              </p>
            </div>
            <div className="blog-card-author">
          ...
          <div className="blog-card">
            <div className="blog-card-content">
              ...
              <p className="blog-card-text">
                Discover practical meal prep tips inspired by fitness
                influencers to simplify your nutrition tracking and stay on
                track.
              </p>
            </div>
            <div className="blog-card-author">
